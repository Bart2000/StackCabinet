...
*/
/**************************************************************************/
Mpu::Mpu(gpio_num_t SDA, gpio_num_t SCL)
{
    // Should be an empty constructor
    _sda = SDA;
    _scl = SCL;
}
...
/**************************************************************************/
/*!
  @brief    Initiates sonar.
  @param    trigger     xxxxxxxxx
  @param    echo        xxxxxxxxx
*/
/**************************************************************************/
esp_err_t Mpu::init() {
    i2c_config_t conf;
...
// #define BUFF_SIZE 6
// #define DELAY_TIME_BETWEEN_ITEMS_MS 500 /*!< delay time between different test items, dt should be small */
...
// void mpu6050_complimentary_filter()
// {
//     int ret;
